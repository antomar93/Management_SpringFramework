	...
	<table>
		...
		<c:forEach var="res" items="${storico}">
			<tr>
				...
				<th>${res.getRuoloCollegato().getStipendio()}</th>
		   ...
		   <th> <a href="${pageContext.request.contextPath}/storico/aggiornaStoricoPerIdStorico?idStorico=${res.getIdStorico()}">  
            ...
            <th> <a href="${pageContext.request.contextPath}/storico/eliminaStoricoPerStipendio?idStorico=${res.idStorico}&stipendio=${stipendio}&dataInizio=${dataInizio}&dataFine=${dataFine}">  
